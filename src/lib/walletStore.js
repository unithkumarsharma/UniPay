...
let memoryStore = {
  users: [
    { id: 'adm001_fallback', userId: 'ADM001', name: 'Surya (Admin)', role: 'admin', phone: '9876543210', email: 'admin@unipay.com', walletBalance: 50000 },
    { id: 'acc001_fallback', userId: 'ACC001', name: 'Unith (Accountant)', role: 'accountant', phone: '9876543211', email: 'accountant@unipay.com', walletBalance: 0 },
    { id: 'md001_fallback', userId: 'MD001', name: 'Ajay (MD)', role: 'master_distributor', phone: '9876543212', email: 'ajay@unipay.com', walletBalance: 10000 },
    { id: 'dst001_fallback', userId: 'DST001', name: 'Ram (Distributor)', role: 'distributor', phone: '9876543213', email: 'ram@unipay.com', walletBalance: 5000 },
    { id: 'rtl001_fallback', userId: 'RTL001', name: 'Rohan (Retailer)', role: 'retailer', phone: '9876543214', email: 'rohan@unipay.com', walletBalance: 2000 },
    { id: 'rtl002_fallback', userId: 'RTL002', name: 'Mohan (Retailer)', role: 'retailer', phone: '9876543215', email: 'mohan@unipay.com', walletBalance: 1500 },
  ],
  logs: [
    ...
    { id: 'LED002', date: new Date().toISOString(), type: 'credit', description: 'Opening Balance MD001 Ajay', amount: 10000, balance: 10000, user_id: 'md001_fallback' },
    { id: 'LED003', date: new Date().toISOString(), type: 'credit', description: 'Opening Balance DST001 Ram', amount: 5000, balance: 5000, user_id: 'dst001_fallback' },
    { id: 'LED004', date: new Date().toISOString(), type: 'credit', description: 'Opening Balance RTL001 Rohan', amount: 2000, balance: 2000, user_id: 'rtl001_fallback' },
    { id: 'LED005', date: new Date().toISOString(), type: 'credit', description: 'Opening Balance RTL002 Mohan', amount: 1500, balance: 1500, user_id: 'rtl002_fallback' },
  ],
  fundRequests: [
    {
      id: 'FR001',
      request_id: 'REQ100001',
      user_id: 'rtl001_fallback',
      user: 'Rohan (Retailer)',
      userCode: 'RTL001',
      requester_role: 'retailer',
      target_approver_role: 'distributor',
      target_approver_name: 'Ram (Distributor)',
      amount: 1000,
      payment_mode: 'UPI',
      reference_no: 'UPI982374912',
      status: 'pending',
      created_at: new Date().toISOString(),
    },
    {
      id: 'FR002',
      request_id: 'REQ100002',
      user_id: 'dst001_fallback',
      user: 'Ram (Distributor)',
      userCode: 'DST001',
      requester_role: 'distributor',
      target_approver_role: 'master_distributor',
      target_approver_name: 'Ajay (MD)',
      amount: 2000,
      payment_mode: 'NEFT',
      reference_no: 'UTR883471029',
      status: 'pending',
      created_at: new Date().toISOString(),
    },
    {
      id: 'FR003',
      request_id: 'REQ100003',
      user_id: 'md001_fallback',
      user: 'Ajay (MD)',
      userCode: 'MD001',
      requester_role: 'master_distributor',
      target_approver_role: 'accountant',
      target_approver_name: 'Unith (Accountant)',
      amount: 5000,
      payment_mode: 'IMPS',
      reference_no: 'UTR321654987',
      status: 'pending',
      created_at: new Date().toISOString(),
    },
    {
      id: 'FR004',
      request_id: 'REQ100004',
      user_id: 'acc001_fallback',
      user: 'Unith (Accountant)',
      userCode: 'ACC001',
      requester_role: 'accountant',
      target_approver_role: 'admin',
      target_approver_name: 'Surya (Admin)',
      amount: 10000,
      payment_mode: 'BANK_TRANSFER',
      reference_no: 'TXN5541092',
      status: 'pending',
      created_at: new Date().toISOString(),
    },
  ],
  transactions: [
    { id: 'TXN001', txn_id: 'TXN99012', user: 'Rohan (RTL001)', user_id: 'rtl001_fallback', type: 'recharge', amount: 299, status: 'success', service_name: 'Jio Mobile Prepaid', commission: 4.5, created_at: new Date().toISOString() },
    { id: 'TXN002', txn_id: 'TXN99013', user: 'Mohan (RTL002)', user_id: 'rtl002_fallback', type: 'bill_payment', amount: 450, status: 'success', service_name: 'Torrent Power Electricity', commission: 5, created_at: new Date().toISOString() },
  ]
};
