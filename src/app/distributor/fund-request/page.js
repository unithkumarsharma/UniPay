...
export default function DistFundRequestPage() {
  ...
  return (
    <>
      <div className="page-header"><h1>Fund Request</h1><p>Request balance from your Master Distributor</p></div>
      <div className="card mb-lg" style={{ maxWidth: 500 }}>
        ...
        <div className="form-group"><label className="form-label">Payment Method</label>
          <select className="form-select"><option>Bank Transfer</option><option>UPI</option></select>
        </div>
      ...
      <DataTable title="Request History" columns={columns} data={fundRequests.slice(0, 3)} />
    </>
  );
}
