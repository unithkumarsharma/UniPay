...
// Fintech Vector SVG Icon Map for All Services
...
const serviceThemeColors = {
  ...
  orange: { bg: 'rgba(245, 158, 11, 0.14)', color: '#D97706' },
          ...
          <div key={category.name} style={{ marginBottom: 32 }}>
            ...
            <div className="services-grid" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: '16px' }}>
              {filteredServices.map((service) => {
                ...
                const theme = serviceThemeColors[service.color] || serviceThemeColors.blue;
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: isActive ? '0 4px 14px -3px rgba(16, 185, 129, 0.12)' : 'none',
                      transition: 'all 0.25s ease',
                      position: 'relative',
                    }}
                    onClick={() => toggleService(service.id)}
                  >
                    {/* SVG Vector Icon Badge */}
                    <div style={{
                      width: 46,
                      height: 46,
